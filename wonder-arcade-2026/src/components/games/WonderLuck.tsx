...
const WonderLuck: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 max-w-4xl mx-auto pt-24">
      ...
      <header className="mb-16 text-center">
        <h2 className="text-4xl font-extrabold text-white tracking-tighter">WONDER LUCK</h2>
        <p className="text-zinc-500 uppercase tracking-widest text-sm mt-2">Daily Gaming Fortune Gacha</p>
      </header>
